...
// In-Memory Fallback Store (Used when database connection is configuring)
export const initialData = {
  ...
  storeItems: [
    { id: "vip-silver", name: "VIP Silver", price: 35000, period: "oyiga", popular: false, color: "#a0aec0", features: "Barcha serverlarga kirish ustunligi, Maxsus VIP Chat tegi, +105 HP" },
    { id: "vip-gold", name: "VIP Gold", price: 65000, period: "oyiga", popular: true, color: "#ffa300", features: "Silver afzalliklari, Har roundda +$1000, Unikal Agent modellari, Auto Defuse Kit" },
    { id: "vip-diamond", name: "VIP Diamond", price: 110000, period: "oyiga", popular: false, color: "#5a80f2", features: "Gold va Silver afzalliklari, Har o'ldirishda +10 HP, Premium Knives & Gloves Skinchanger" },
    { id: "custom-fov", name: "Custom FOV Unlock", price: 25000, period: "oyiga", popular: false, color: "#64ce82", features: "FOV 120 gradusgacha kengaytirish, Qurol ko'rinish joylashuvi" },
    { id: "reserved-slot", name: "Reserved Slot Access", price: 20000, period: "oyiga", popular: false, color: "#ff4940", features: "Server 100% to'lganida ham ustun ulanish" },
    { id: "skin-pass", name: "Premium Skin Pass", price: 45000, period: "oyiga", popular: false, color: "#e2e8f0", features: "CS2 ning eng so'nggi va qimmatbaho pichoqlari hamda stikerlar" }
  ],
  leaderboard: [
...
export const db = {
  ...
  storeItems: [...initialData.storeItems],
  leaderboard: [...initialData.leaderboard],
  bans: [...initialData.bans],
  requests: [],
  payments: [],
  users: {}
};
